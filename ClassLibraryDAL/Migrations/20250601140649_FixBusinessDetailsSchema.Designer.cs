...
namespace ClassLibraryDAL.Migrations
{
    ...
    [Migration("20250601140649_FixBusinessDetailsSchema")]
    partial class FixBusinessDetailsSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassLibraryEntities.Category", b =>
                {
                    b.Property<int>("CategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ClassLibraryEntities.Discount", b =>
                {
                    ...
                    b.Property<string>("BusinessTransactionId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("BusinessTransactionId");
            ...
            modelBuilder.Entity("ClassLibraryEntities.TransactionItem", b =>
                {
                    ...
                    b.Property<bool>("IsRateListItem")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ClassLibraryEntities.Discount", b =>
                {
                    b.HasOne("ClassLibraryEntities.BusinessDetails", null)
                        .WithMany("DefaultDiscounts")
                        .HasForeignKey("BusinessDetailsId");

                    b.HasOne("ClassLibraryEntities.BusinessModel", "BusinessModel")
                        .WithMany("DefaultDiscounts")
                    ...
                    b.HasOne("ClassLibraryEntities.BusinessTransaction", null)
                        ...
                        .HasForeignKey("BusinessTransactionId");
